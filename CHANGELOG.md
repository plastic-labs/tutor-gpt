...
- Arcjet for bot detection, rate limiting, and WAF protection

### Changed

- UI to be streamlined and include thoughts and tool calls in line with the
  conversation
- `freeMessage` default is now 10 messages
