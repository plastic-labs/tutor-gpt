...
const thoughtWithPDFPrompt: Message[] = [
  ...
  - Honcho's response in <honcho-response></honcho-response>
  - PDF Agent's response in <pdf-response></pdf-response>
  ...
  4. Any text after that is the user's latest message
