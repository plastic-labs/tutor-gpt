      ...
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        ...
        >
          <div className="max-w-xl lg:max-w-3xl">
            ...
            {formType === 'signIn' && (
              <SignIn handler={handleSignIn} stateSync={setFormType}/>
            )}
            {formType === 'signUp' && (
              <SignUp handler={handleSignUp} stateSync={setFormType} />
            )}
            {formType === 'forgot' && (
             <Forgot handler={handleForgotPassword} stateSync={setFormType} />
            )}
          </div>
        </main>
      </div>
